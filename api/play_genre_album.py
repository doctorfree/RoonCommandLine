        ...
        for genre in genres:
            ...
            if albums:
                ...
                roonapi.play_media(output_id,
                                   ["Genres", genre,
                                    "Albums", album], None, False)
                if len(albums) > 1:
                    print("\nAlbum titles in", genre,
                          "genre matching", albumsearch, ":\n")
                    print(*albums, sep="\n")
                    print("\nTo play an album in this genre by name specify")
                    print("the full name or enough of a substring for a single match\n")
                break
        if album is None:
