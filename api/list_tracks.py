...
parser.add_argument("-q", "--quiet", help="only output track titles")
...
tracks = roonapi.list_media(output_id, ["Library", "Tracks", tracksearch])
...
if tracks:
    ...
    if verbose:
        if tracksearch == "__all__":
            print("\nTrack titles in Library:\n")
        else:
            print("\nTrack titles in Library matching", tracksearch, ":\n")
    print(*tracks, sep="\n")
