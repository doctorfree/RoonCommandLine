...
Usage: roon -L -S -u
    -A album -a artist -C composer -g genre -G zone_group
    -l [albums|artists|artalbums|composers|genres|genalbums|genartists|playlists|tags|zones]
    -s search -p playlist -t tag -z zone -r radio
...
Where:
    ...
    -l [albums|artists|artalbums|composers|genres|genalbums|genartists|playlists|tags|zones] indicates list albums, artists, genres, albums in genre, artists in genre, playlists, tags, or Roon zones
