...
```bash
sudo apt install ./RoonCommandLine_2.1.1-2.deb
```

Install the package on RPM based systems by executing the command

```bash
sudo yum localinstall ./RoonCommandLine-2.1.1-2.rpm
```
...
View the full changelog for this release at <https://github.com/doctorfree/RoonCommandLine/blob/v2.1.1r2/CHANGELOG.md>
